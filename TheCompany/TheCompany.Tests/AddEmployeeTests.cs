...
namespace TheCompany.Tests
{
    ...
    /// for testing (they will have a string called dataToPassIn, and will use Console.SetIn() and StringReader). 
    /// To test the methods with user input, Console.SetIn() and StringReader are used to simulate the user 
    /// input. The idea/code to use the Console.SetIn() and StringReader for user input was borrowed from Assaf 
    /// Stone's post at this link:
